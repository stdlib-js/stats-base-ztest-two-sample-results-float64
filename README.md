...
```javascript
Float64Results = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ztest-two-sample-results-float64@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var Float64Results = require( 'path/to/vendor/umd/stats-base-ztest-two-sample-results-float64/index.js' )
```
